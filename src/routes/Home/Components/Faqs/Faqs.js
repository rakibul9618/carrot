...
const topics = [
  ...
  },
  {
    ...
    qna: [
      ...
      { answer: 'When a loan is secured on Carrot, your Carrot partner app receives instructions to lock assets worth the amount borrowed and an extra 20% of the principal. The additional 20% included, serves as a buffer to mitigate the risks that may arise from fluctuations in stock prices.', question: 'How does my Carrot partner app determine the amount of assets held?' },
